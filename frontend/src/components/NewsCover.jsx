  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {v.tier && (
          <span style={{
            fontSize: compact ? 9 : 10, fontWeight: 700, color: '#e8e8e8',
            padding: '3px 8px', borderRadius: 999,
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, minWidth: 0 }}>
          ...
          />
          {!compact && (
            <span style={{ fontSize: 11, fontWeight: 700, color: '#d7d7d7', maxWidth: 120, textAlign: 'center', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {teamA.name}
            </span>
          )}
        </div>
      ...
      {v.tournamentName && (
        <div style={{
          ...
          fontSize: compact ? 9 : 10, color: '#b8b8b8', fontWeight: 600,
